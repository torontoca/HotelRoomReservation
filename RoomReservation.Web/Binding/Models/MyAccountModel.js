...
(function (cr) {
    var MyAccountModel = function (accountId, loginEmail, firstName, lastName, address, city, state, zipCode, creditRoomd, expDate) {
        ...
        self.CreditRoomd = ko.observable(creditRoomd).extend({
            required: { message: "Credit roomd number is required" },
            pattern: { message: "Credit roomd is invalid", params: /^\d{16}$/ }
        });
