...
(function (cr) {
    var AccountRegisterViewModel = function () {
        ...
        self.initialize = function () {
            self.accountModelStep1(new RoomRental.AccountRegisterModelStep1());
            self.accountModelStep2(new RoomRental.AccountRegisterModelStep2());
            self.accountModelStep3(new RoomRental.AccountRegisterModelStep3());
        ...
        self.nextStep = function (model) {
            ...
            if (self.viewMode() == 'register1') {
                ...
                if (errors().length == 0) {
                    self.viewModelHelper.apiPost('api/account/validateregistrationstep1', unmappedModel,
                        function (result) {
                ...
                self.viewModelHelper.modelIsValid(valModel.isValid());
                if (errors().length == 0) {
                    self.viewModelHelper.apiPost('api/account/validateregistrationstep2', unmappedModel,
                    function (result) {
                ...
                self.viewModelHelper.modelIsValid(valModel.isValid());
                if (errors().length == 0) {
                    self.viewModelHelper.apiPost('api/account/validateregistrationstep3', unmappedModel,
                    function (result) {
