...
$.extend($.validator, {
	...
	messages: {
		...
		creditroomd: "Please enter a valid credit roomd number.",
	...
	methods: {
		...
		// http://docs.jquery.com/Plugins/Validation/Methods/creditroomd
		// based on http://en.wikipedia.org/wiki/Luhn
		creditroomd: function(value, element) {
			if ( this.optional(element) )
				return "dependency-mismatch";
